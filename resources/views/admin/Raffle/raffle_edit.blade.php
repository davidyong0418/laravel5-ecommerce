                    ...
                    <div class="row mb-5">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                @if(!empty($product))
                                    <form action="<?php echo url('admin/raffle-view/edit') ?>/{{$product->id}}" method="post" accept-charset="UTF-8" class="form-horizontal" enctype='multipart/form-data'>
                                    <div class="box-body">
                                            ...
                                            <div class="tab-content fields-group">
                                                <div class="tab-pane active" id="tab-form-1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <label for="price" class="col-sm-6 control-label">Product Price*</label>

                                                        <div class="col-sm-8">
                                                                <input type="number" id="price" name="price" value="{{$product->price}}" class="form-control" placeholder="Input Price" required="">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-8">
                                                                ...
                                                                <input type="number" id="total_ticket" name="total_ticket" value="{{$product->total_ticket}}" class="form-control" placeholder="Input Total Ticket">
                                                        </div>
                                                    </div>
                                                    
                                                    <div class="form-group">

                                                        <label for="booked_ticket" class="col-sm-6 control-label">Booked ticket</label>

                                                        <div class="col-sm-8">
                                                                <!-- <span class="input-group-addon"><i class="fa fa-envelope"></i></span> -->
                                                                <!-- <input type="number" id="booked_ticket" name="booked_ticket" value="{{$booked_ticket}}" class="form-control" placeholder="Input Booked Ticket" disabled> -->
                                                               <h5>
                                                                     @if($product->raffle_end < date('Y-m-d H:i:s'))
                                                                        Date Over
                                                                    @elseif($product->total_ticket <= $booked_ticket)
                                                                        Ready to Run Raffle
                                                                    @else
                                                                        Running
                                                                    @endif
                                    ...
                                    <div class="box-footer row">
                                        ...
                                        <div class="col-md-8">
                                            ...
                                            <div class="btn-group pull-right">
                                                <a href="<?php echo url('admin/raffle-view') ?>/edit/{{$product->id}}" class="btn btn-warning">Reset</a>
                                            </div>
                                            <div class="btn-group pull-right">
                                                <a class="btn btn-default form-history-back" href="{{url('admin/raffle-view')}}"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
                                            </div>
                                        </div>
